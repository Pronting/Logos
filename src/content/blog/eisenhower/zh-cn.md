---
title: GitHub Actions 实践指南：从零到部署 ishwe
pubDate: 2026-04-18
description: 用github actions ci/cd，小网站的最优选择
tags: [ishwe,github]
image: "actions.png"
draft: false
slugId: assets/actions.png
---




放上仓库信息，未来会开放专栏记录开发日志

::github{repo="Pronting/eisenhower"}
...
2. [核心概念](#2-核心概念)
3. [ishwe 的 CI/CD 架构](#3-ishwe-的-cicd-架构)
4. [从零开始配置](#4-从零开始配置)
5. [踩坑记录与解决方案](#5-踩坑记录与解决方案)
6. [GitHub Actions 常见问题解答](#6-github-actions-常见问题解答)
7. [经验总结](#7-经验总结)
...
| 经验                                  | 说明                           |
| ------------------------------------- | ------------------------------ |
| 用 `fetch + reset --hard` 替代 `pull` | 避免冲突，适合 CI/CD 场景      |
...
| `docker-compose.yml` 的 `env_file` 引用 `.env` | 密钥通过环境变量传入容器               |
